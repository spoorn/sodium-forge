...
public class EntityLighter {
    ...
    public static <T extends Entity> int getBlendedLight(EntityLightSampler<T> lighter, T entity, float tickDelta) {
        ...
        double x1 = MathHelper.lerp(tickDelta, entity.xo, entity.getX());
        double y1 = MathHelper.lerp(tickDelta, entity.yo, entity.getY());
        double z1 = MathHelper.lerp(tickDelta, entity.zo, entity.getZ());
